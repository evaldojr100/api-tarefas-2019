class TarefaController {
  ...
  // quando o método pesquisa é executado,
  // é retornado um array de tarefa para depois a lista de tarefas ser limpa e preenchida novamente

  listarPorDescricao(pesquisa) {
    this._tarefaService.listarPorDescricao(pesquisa)
      .then(tarefas => {
        this._tarefas.limpar()
        tarefas.map(tarefa => {
          this._tarefas.adicionar(tarefa)
